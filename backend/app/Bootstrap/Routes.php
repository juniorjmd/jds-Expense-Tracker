...
final class Routes
{
    public static function definitions(): array
    {
        ...
        return [
            ...
            ['POST', '/api/auth/change-superuser-password', [$authController, 'changeSuperuserPassword']],
            ['POST', '/api/auth/reset-superuser-password', [$authController, 'resetSuperuserPassword']],
            ...
            ['POST', '/api/establishments/{id}/movements', [$transactionController, 'storeMovement']],
            ['PUT', '/api/transactions/{id}', [$transactionController, 'update']],
            ['PUT', '/api/transactions/movements/{groupId}', [$transactionController, 'updateMovement']],
